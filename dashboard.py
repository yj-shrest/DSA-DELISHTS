...
class DashboardFrame(CTkFrame):
    def __init__(self, parent_frame, **kwargs):
        ...
        filterBar = CTkEntry(search_frame, placeholder_text="Filter", fg_color="#393A3B", border_width=0, text_color="#BFBBBB")
        filterBar.grid(row=0, column=1, sticky="nsew", pady=40)
